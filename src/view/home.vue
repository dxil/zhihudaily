...
<template>
  <div class="main-list" id="foo">
    <home-header :show-sidebar.sync="showSidebar" :title="title" :tip="tip" :icon-display="iconDisplay"></home-header>
    <!-- 侧边栏 -->
...
export default {
  ...
  methods: {
    ...
    showBar () {
      window.document.body.classList.add = 'scoll-stop'
      window.document.querySelector('html').classList.add = 'scoll-stop'
